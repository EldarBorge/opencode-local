...
const DEFAULT_CHANGELOG_URL =
  typeof location === "object" && location.hostname.includes("opencode.ai") ? "https://opencode.ai/changelog.json" : ""
const CHANGELOG_URL = import.meta.env.VITE_OPENCODE_CHANGELOG_URL || DEFAULT_CHANGELOG_URL
